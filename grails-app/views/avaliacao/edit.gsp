                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="nome"><g:message code="avaliacao.nome.label" default="Nome" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: avaliacaoInstance, field: 'nome', 'errors')}">
                                    <g:textField name="nome" value="${avaliacaoInstance?.nome}" />
                                </td>
                            </tr>
